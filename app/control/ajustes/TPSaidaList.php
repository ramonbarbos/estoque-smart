...
class TPSaidaList extends TPage
{
    private $form;
    private $datagrid;
    ...
    public function __construct(){
        ...
        $this->form = new BootstrapFormBuilder('formulario tipo_saida');
        $this->form->setFormTitle('Tipo_Saida');

        //Criação de fields
        $nome = new TEntry('nome');

        //Add filds na tela
        $this->form->addFields( [new TLabel('Tipo de Entrada')], [ $nome ] );
        ...
        $this->form->addActionLink(_t('New'), new TAction(['TPSaidaForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green'  );
        ...
        $action1 = new TDataGridAction(['TPSaidaForm', 'onEdit'], ['id'=> '{id}', 'register_state' => 'false']);
