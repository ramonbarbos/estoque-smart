...
class TPEntradaList extends TPage
{
    private $form;
    private $datagrid;
    ...
    public function __construct(){
        ...
        $this->form->addActionLink(_t('New'), new TAction(['TPEntradaForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green'  );
        ...
        $action1 = new TDataGridAction(['TPEntradaForm', 'onEdit'], ['id'=> '{id}', 'register_state' => 'false']);
